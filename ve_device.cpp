...
VkResult CreateDebugUtilsMessengerEXT(
    ...
    if (func != nullptr) {
        ...
        std::cerr << "CreateDebugUtilsMessengerEXT() failed!\n";
...
void DestroyDebugUtilsMessengerEXT(
    ...
    if (func != nullptr) {
        ...
        std::cerr << "DestroyDebugUtilsMessengerEXT() failed!\n";
    }
}
...
// Constructor
VeDevice::VeDevice(VeWindow &veWindow) : veWindow{veWindow} {
    createInstance();
    setupDebugMessenger();
    createSurface();
    pickPhysicalDevice();
...
// Finds and chooses a Vulkan-capable physical device.
